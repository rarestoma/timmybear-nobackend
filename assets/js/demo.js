   ...
   initPickColor: function(){
    ...
    initFormExtendedDatetimepickers: function(){
        $('.datetimepicker').datetimepicker({
            icons: {
                time: "nc-icon nc-watch-time",
                date: "nc-icon nc-calendar-grid-58",
                up: "nc-icon nc-bold-up",
                down: "nc-icon nc-bold-down",
                previous: 'nc-icon nc-bold-left',
                next: 'nc-icon nc-bold-right',
...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    chartsPage: function(){
        ...
        var dataLineChart = {
            labels: 
                ['6pm', '9pm', '11pm', '2am', '4am', '8am', '2pm', '5pm', '8pm', '11pm', '4am'],
            series: [
                [0, 10, 12, 6, 8, 14, 17, 9, 7, 13, 18]
            ]
        };
        ...
        var optionsLineChart = {
         ...
         new Chartist.Line('#lineChart', dataLineChart, optionsLineChart);

        var dataLinePointsChart = {
            labels: ["'07", "'08", "'09", "'10", "'11", "'12", "'13", "'14", "'15"],
            series: [
                [20, 30, 40, 50, 60, 40, 60, 70, 80]
            ]

        };

        var optionsLinePointsChart = {
            lineSmooth: Chartist.Interpolation.simple({
                divisor: 100
            }),
        ...
        new Chartist.Line('#linePointChart', dataLinePointsChart, optionsLinePointsChart);

        var dataLineMultipleChart = {
            labels: ["'07", "'08", "'09", "'10", "'11", "'12", "'13", "'14", "'15"],
            series: [
                [0, 50, 100, 150, 250, 200, 300, 350, 400],
                [100, 150, 200, 250, 350, 300, 400, 450, 500],
                [300, 350, 450, 500, 600, 550, 650, 700, 750]
            ]
        };

          var optionsLineMultipleChart = {
            lineSmooth: Chartist.Interpolation.simple({
        ...
        new Chartist.Line('#lineMultipleChart', dataLineMultipleChart, optionsLineMultipleChart);
        ...
        var simpleBarChart = Chartist.Bar('#barChart', dataSimpleBarChart, optionsSimpleBarChart, responsiveOptionsSimpleBarChart);
    ...
    initFullCalendar: function(){
        ...
        $calendar.fullCalendar({
            ...
            // color classes: [ event-azure | event-green | event-orange | event-red ]
            events: [
                {
                    title: 'All Day Event',
